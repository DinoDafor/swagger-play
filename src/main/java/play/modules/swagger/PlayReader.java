...
public class PlayReader {
    ...
    private Type getParamType(Class<?> cls, Method method, String simpleTypeName, int position) {
        ...
        try {
            ...
            Logger.error(String.format("Exception getting parameter type for method %s, param %s at position %d",
    ...
    private List<Annotation> getParamAnnotations(Class<?> cls, Type[] genericParameterTypes,
        ...
        try {
            ...
            Logger.error(String.format("Exception getting parameter type for %s at position %d", simpleTypeName,
                    fieldPosition), e);
            return null;
        }
    }
